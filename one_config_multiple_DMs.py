...
"""
    Calls the main program with numerous fixed arguments, and returns the observed performance on multiple decision makers.
    Change the parameters at hand to test various configurations.
    This code was used to generate data analyzed in Section 5 of the article.
"""
...
NB_TESTS = 10
VERBOSE = True
OUTPUT = "./one_config_multiple_DMs.csv"
...
HYPERPARAMETERS = {"--nb_criteria" : {"init" : 11}, # Fixed
                   ...
                   "--ratio_comparisons_with_error" : {"init" : 0.0}, # Fixed
                   ...
                   "--mutation_shrink_profiles__shrink_factor" : {"init" : 1.0}, # Fixed
                   "--mutation_shrink_profiles__individual_criterion_proba" : {"init" : 1.0}, # Fixed
                   "--mutation_expand_profiles__expand_factor" : {"init" : 0.2}, # Fixed
                   "--mutation_expand_profiles__individual_criterion_proba" : {"init" : 1.0}, # Fixed
                   "--prepare_new_population__elitism_ratio" : {"init" : 0.5}, # Fixed
                   ...
                   "--make_crossover__crossover_mix_criteria_and_weights_probability" : {"init" : 1.0}, # Fixed
                   "--make_mutation__mutation_random_profile_perturbation_probability" : {"init" : 0.2}, # Fixed
